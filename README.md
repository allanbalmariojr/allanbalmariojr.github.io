...
Skilled in QA automation using Python, Selenium WebDriver, and Page Object Model (POM), along with API testing (Postman) and SQL-based data validation.
...
## 🧠 QA Approach
- Design test cases using structured techniques (EP, BVA)
- Execute testing across UI, API, and database layers
- Identify edge cases and failure scenarios
- Document defects with clear reproducibility and impact
- Maintain automation scripts using Selenium POM architecture
...
[Tacoma Community College - Associate of Arts (AA) in Computer Science (August 2025)](https://github.com/user-attachments/files/27560058/d3b72b90-4bfc-11f1-85a3-9340f60ac15e.pdf)
